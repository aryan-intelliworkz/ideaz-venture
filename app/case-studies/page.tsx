        ...
        <div className="flex flex-col gap-12 lg:gap-16">
          {caseStudies.map((cs, i) => {
            ...
            return (
              <RevealSection
                key={cs.slug}
                className={isEven ? "reveal-slide-left" : "reveal-slide-right"}
                threshold={0.1}
              >
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                  {/* Text Content */}
                  <div
                    className={`flex flex-col px-6 md:px-8 lg:pl-[160px] lg:pr-12 py-8 md:py-10 lg:py-14 ${
                      !isEven ? "lg:order-2 lg:pl-12 lg:pr-[160px]" : ""
                    }`}
                  >
                    {/* Tag */}
                  ...
                  {/* Image — full bleed to browser edge */}
                  <div
                    className={`relative w-full aspect-[4/3] lg:aspect-auto lg:h-full min-h-[280px] md:min-h-[340px] lg:min-h-[450px] ${
                      !isEven ? "lg:order-1" : ""
                    }`}
                  >
                    <Image
