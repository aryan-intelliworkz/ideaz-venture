    ...
    <>
      ...
      <section className="py-12 md:py-16 lg:py-24">
        <div className="mx-auto max-w-[1920px] px-6 md:px-8 lg:px-[160px]">
          ...
          <div className="hidden lg:flex items-stretch border border-white/[0.08] rounded-[4px] overflow-hidden min-h-[320px]">
            ...
            <div className="w-[300px] shrink-0 p-10 flex flex-col justify-center gap-6 border-r border-white/[0.08]">
              ...
              <div className="absolute left-[175px] top-[calc(50%-40px)] w-px h-[80px] border-l border-dashed border-white/[0.15] hidden" />
            </div>
          ...
          <div className="lg:hidden space-y-4">
            {workWithData.map((item, index) => (
              <div
                ...
                onClick={() => handleWorkWithClick(index)}
                className={cn(
                  "border border-white/[0.08] rounded-[4px] overflow-hidden cursor-pointer transition-all duration-300",
